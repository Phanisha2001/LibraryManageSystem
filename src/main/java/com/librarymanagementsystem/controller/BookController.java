...
public class BookController {
	...
	@ResponseBody
	public void borrowBook(@RequestParam("bookName") String bookName) {
		bookService.borrowBookByName(bookName);
	}

	@PutMapping("/book/return")
	@ResponseBody
	public void returnBook(@RequestParam("bookName") String bookName) {
		bookService.returnBookByName(bookName);
	}
}
